...
def banner():
    ...
    print(f"{G}├──────────────────────────────────────────────────────────┤{W}")
    print(f"{G}│ BKASH NO : 01736602421                                   │{W}")
    print(f"{G}│ BKASH NM : RAJA VAU                                      │{W}")
    print(f"{G}├──────────────────────────────────────────────────────────┤{W}")
    print(f"{G}│ NAGAD NO : 01736602421                                   │{W}")
    print(f"{G}│ NAGAD NM : RAJA VAU                                      │{W}")
    print(f"{G}├──────────────────────────────────────────────────────────┤{W}")
    print(f"{G}│ 3 DAYS   : 300 BDT                                       │{W}")
    print(f"{G}│ 7 DAYS   : 650 BDT                                       │{W}")
    print(f"{G}│ 30 DAYS  : 1300 BDT                                      │{W}")
    print(f"{G}└──────────────────────────────────────────────────────────┘{W}\n")
